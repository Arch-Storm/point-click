...
//storageRoom
  ...
  //to hallway02 (back)
  MoveToSceneObject storageTohallway02 = new MoveToSceneObject("storageRoom_hallway02", 152*xs, 160*ys, 16*xs, 16*xs, "arrowUp.png", true, "upCursor");
...
//barracksRoom
  ...
  //to hallway01 (back)
  MoveToSceneObject barrackstohallway01 = new MoveToSceneObject("barracks_hallway01", 140*xs, 100*ys, 16*xs, 16*xs, "arrowUp.png", true, "upCursor");
...
//hallway02 
  ...
  //toStorageRoom
  if (debugSolvedPuzzles) {
    MoveToSceneObject h2ToStorageRoom = new MoveToSceneObject("hallway02_StorageRoom", 215*xs, 90*ys, 16*xs, 16*xs, "arrowRight.png", "storageRoom", "rightCursor");
